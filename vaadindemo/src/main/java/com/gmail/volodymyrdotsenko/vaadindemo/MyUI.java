...
import com.gmail.volodymyrdotsenko.vaadindemo.domain.Person;
import com.gmail.volodymyrdotsenko.vaadindemo.domain.PersonRepository;
...
public class MyUI extends UI {
	...
	protected void init(VaadinRequest request) {
		setContent(new MVerticalLayout(new RichText().withMarkDownResource("/welcome.md"),
